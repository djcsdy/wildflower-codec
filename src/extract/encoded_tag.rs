    ...
    pub fn decode(self) -> Tag {
        ...
        match self.tag_type {
            ...
            TagType::DefineBits => read_define_bits_tag(&mut slice_reader)
                .map(Tag::DefineBits)
                .unwrap_or_else(|_| Tag::Invalid(self.into_invalid())),
            TagType::DefineButton => Tag::Unknown(self.into_unknown()),
            ...
            TagType::DefineBitsJpeg3 => read_define_bits_jpeg3_tag(&mut slice_reader)
                .map(Tag::DefineBitsJpeg3)
                .unwrap_or_else(|_| Tag::Invalid(self.into_invalid())),
            TagType::DefineBitsLossless2 => read_define_bits_lossless2_tag(&mut slice_reader)
            ...
            TagType::DefineMorphShape => read_define_morph_shape_tag(&mut slice_reader)
                ...
                .unwrap_or_else(|_| Tag::Invalid(self.into_invalid())),
            TagType::DefineFont2 => Tag::Unknown(self.into_unknown()),
